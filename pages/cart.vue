                ...
                <div class="grid grid-cols-12">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between pb-8 border-b border-gray-300">
                            ...
                            <h2 class="font-manrope font-bold text-xl leading-8 text-gray-600">3 Sản phẩm</h2>
                        </div>
                            ...
                            <div class="col-span-12 md:col-span-5">
                                <div class="grid grid-cols-5">
                                    ...
                                    <div class="col-span-2">
                                        <p class="font-normal text-lg leading-8 text-gray-400 text-center">Tổng Tiền</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="mt-8">
                            <div class="flex items-center justify-between pb-6">
                                <p class="font-normal text-lg leading-8 text-black">3 Sản phẩm</p>
                            ...
                            <form>
                                ...
                                <div class="flex items-center justify-between py-8">
                                    <p class="font-medium text-xl leading-8 text-black">3 Sản phẩm</p>
                                    <p class="font-semibold text-xl leading-8 text-indigo-600">$485.00</p>
                                </div>
                                <button
                                    class="w-full text-center bg-indigo-600 rounded-xl py-3 px-6 font-semibold text-lg text-white transition-all duration-500 hover:bg-indigo-700">Thanh Toán</button>
                            </form>
                        </div>
                    </div>
